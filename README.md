# Web Scraping Project: Extracting Restaurant Data from Dineout (Pune)
# Hotel Dineout Scraper

This web scraping project is designed to extract restaurant data from the Dineout website (https://www.dineout.co.in/Pune-restaurants) for restaurants located in Pune. The script navigates through all 35 pages of the website, capturing essential information (Name, Address, Price for 2 people per day and Rating) about each restaurant / hotel and storing it in a CSV file.
